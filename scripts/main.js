...
function changeContent(toShow) {
    ...
    if (toShow == 'about') {
        ...
        text.appendChild(document.createTextNode(`I am a focused Computer Science graduate with strong problem-solving skills, a willingness to learn new
        ...
        text = document.createElement('p');
        text.appendChild(document.createTextNode(`I completed my GCSEs and A-Levels at Mascalls Academy. 
        ...
        text = document.createElement('p');
        text.appendChild(document.createTextNode(`I currently work as a software developer at HNF Consultancy. My work there involves maintaining and updating vehicle
        ...
        text = document.createElement('p');
        text.appendChild(document.createTextNode('As well as the above technologies, I have experience with Python, C++, C, and Java.'));
        newContent.push(text);
        ...
        text = document.createElement('p');
        text.appendChild(document.createTextNode(`In my spare time I enjoy playing video games, chatting with my friends and watching TV. I also enjoy doing programming
        ...
        text = document.createElement('p');
        text.appendChild(document.createTextNode('Get out of dev tools nerd'));
        newContent.push(text);
    }
